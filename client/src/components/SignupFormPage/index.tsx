...
const SignupFormPage: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        if (newErrors.email == null && newErrors.password == null && newErrors.confirmPassword == null) {
    ...
    const usernameClass = errors.username ? 'signup-form-errors signup-form-input' : 'signup-form-input';
