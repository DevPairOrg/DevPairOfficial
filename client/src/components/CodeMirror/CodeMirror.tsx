  ...
  return (
    <>
      <div id="ide-container">
        ...
        <button onClick={() => createJSSubmissionOnLocal()}>
          JAVASCRIPT SUBMISSION
        </button>
        <button onClick={() => createPySubmissionOnLocal()}>
          PYTHON SUBMISSION
        </button>
        <div>
        ...
        <div>
          ...
          >
            ...
            <div style={{ display: "flex", gap: "5px" }}>
              ...
              <button
                onClick={(e) =>
                  handlePythonButton(e, setLanguage, setValue, defaultPythonFn)
                }
                id="python-button"
              >
                Python
              ...
              <button
                onClick={(e) =>
                  handleJavascriptButton(e, setLanguage, setValue, defaultJsFn)
                }
