                ...
                <form onSubmit={handleConfirmEdit} id="edit-user-profile-form">
                    <div id="edit-form-content-wrapper">
                        ...
                        <div>
                            ...
                            {errors.link_github ? <p className="errors">* {errors.link_github}</p> : null}
                            ...
                            {errors.link_linkedin ? <p className="errors">* {errors.link_linkedin}</p> : null}
                            <div className="edit-form">
                                <label>
                                    Portfolio Link
                                    <input
                            ...
                            {errors.link_portfolio ? <p className="errors">* {errors.link_portfolio}</p> : null}
                            <div className="edit-form">
                                <label>
                                    Leetcode Link
                                    <input
                            ...
                            {errors.link_leetcode ? <p className="errors">* {errors.link_leetcode}</p> : null}
                        </div>
                    </div>
